<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
            <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 sm:col-span-4">
                ...
                <div class="mt-2" x-show="! photoPreview">
                    <img src="/storage/{{ $this->user->avatar_url }}" alt="{{ $this->user->name }}" class="object-cover w-20 h-20 rounded-full">
                </div>
        ...
        <!-- Services -->
            ...
            <x-input id="services" type="text" class="block w-full mt-1" wire:model="state.services" required autocomplete="services" />
